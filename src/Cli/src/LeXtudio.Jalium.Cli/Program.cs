...
namespace LeXtudio.Jalium.Cli
{
    public static class Program
    {
        ...
        private static int UnknownCommand(string command)
        {
            ...
            Console.Error.WriteLine("Run 'dotnet jalex --help' for available commands.");
            return 1;
        }

        private static void ShowHelp()
        {
            Console.WriteLine("LeXtudio.Jalium.Cli - Jalium command line utility");
            Console.WriteLine();
            Console.WriteLine("Usage: dotnet jalex [options] <command> [command-options]");
            Console.WriteLine();
            ...
            Console.WriteLine("  doctor       Validate the Jalium development environment");
            Console.WriteLine("  version      Display CLI and environment version information");
            Console.WriteLine("  new          Scaffold a new Jalium app");
            Console.WriteLine("  build        Build a Jalium project");
            Console.WriteLine("  run          Run a Jalium application");
            Console.WriteLine("  publish      Publish a Jalium application");
            Console.WriteLine("  package      Package Jalium output artifacts");
            Console.WriteLine("  diagnostics  Run Jalium diagnostics and validation");
            Console.WriteLine("  env          Inspect installed SDKs and tooling");
            Console.WriteLine("  devflow      Query a running Jalium DevFlow agent and inspect runtime state");
